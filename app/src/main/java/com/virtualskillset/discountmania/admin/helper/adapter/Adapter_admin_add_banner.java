...
import com.virtualskillset.discountmania.admin.AdminMerBanner;
import com.virtualskillset.discountmania.merchant.retro.ModelMerBanner;

import java.util.List;

public class Adapter_admin_add_banner extends BaseAdapter {
    private Context mContext;
    private List<ModelMerBanner> lst;
    AdminMerBanner frag;


    public Adapter_admin_add_banner(Context context, List<ModelMerBanner> lst , AdminMerBanner frag) {
        mContext = context;
        this.lst = lst;
        this.frag = frag;
    }
