...
public class AdminAddMerchantActivity extends AppCompatActivity {
   ...
   // private boolean timm=false;
    ...
    Context ctx=AdminAddMerchantActivity.this;
    private int resm=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_add_merchant);
        try{
           AdminAddMerchantActivity.this.setTitle("Add Merchant");}catch (NullPointerException e){};
        try {
      ...
      //  inputOTP=(EditText)findViewById(R.id.otp);
        ...
        progressDialog = new ProgressDialog(AdminAddMerchantActivity.this);
        ...
        btn_loc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // check if GPS enabled
                    ...
                    try {
                        startActivityForResult(builder.build(AdminAddMerchantActivity.this), PLACE_PICKER_REQUEST);
                    }catch (Exception e){}
        ...
        call.enqueue(new Callback<List<ModelDistricts>>() {
            ...
            public void onResponse(Call<List<ModelDistricts>> call, retrofit2.Response<List<ModelDistricts>> response) {
                ...
                if (modelData != null) {
                    ...
                    Toast.makeText(AdminAddMerchantActivity.this, response.message() + " Error Null", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<ModelDistricts>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(AdminAddMerchantActivity.this, "Unable to connect please try later", Toast.LENGTH_SHORT).show();
                call.cancel();
            }
        });
        ...
        if(resm==0) {
            ...
            builder.setTitle("Reset")
                    ...
                    .setNegativeButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(AdminAddMerchantActivity.this, AdminAddMerchantActivity.class);  //your class
                            startActivity(i);
                            finish();
                        }
                    })
