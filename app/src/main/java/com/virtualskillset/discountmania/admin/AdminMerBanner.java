...
import com.virtualskillset.discountmania.admin.helper.adapter.Adapter_admin_add_banner;
 ...
 */
public class AdminMerBanner extends Fragment {
    private APIService uploadAPIService;
    private APIService apiIfc;
    ...
    private Adapter_admin_add_banner adapterViewAndroid;
    private Context mContext;
    ////grid///
    GridView androidGridView;


    public AdminMerBanner() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_profile_updt_banner, container, false);
    ...
    private void uploadMultiFile() {
        ...
        builder.addFormDataPart("id", AdminAddMerImgActivity.m_id+"");
...
//write the bytes in file
    ...
    private void getOffer() {
      ...
      /*  User user = SharedPrefManager.getInstance(mContext).getUser();
        ...
        Call<List<ModelMerBanner>> call = apiIfc.getMerBanner(AdminAddMerImgActivity.m_id);
        call.enqueue(new Callback<List<ModelMerBanner>>() {
            ...
            public void onResponse(Call<List<ModelMerBanner>> call, retrofit2.Response<List<ModelMerBanner>> response) {
                ...
                if (model.contains(null) || model.isEmpty()) {
                    ...
                    adapterViewAndroid = new Adapter_admin_add_banner(mContext, model,AdminMerBanner.this);
    ...
    public void delProduct(int idd) {
        ...
        // User user = SharedPrefManager.getInstance(mContext).getUser();
        Call<ModelResponse> call = apiIfc.MerDeleteBanner(idd+"","DELETE");
        call.enqueue(new Callback<ModelResponse>() {
            @Override
