...
import com.virtualskillset.discountmania.admin.helper.adapter.Adapter_admin_add_product;
 ...
 */
public class AdminMerProduct extends Fragment {
    ...
    private Adapter_admin_add_product adapterViewAndroid;
...
//write the bytes in file
    ...
    private void getOffer() {
        ...
        Call<List<ModelMerProduct>> call = apiIfc.getMerProduct(AdminAddMerImgActivity.m_id);
        call.enqueue(new Callback<List<ModelMerProduct>>() {
            ...
            public void onResponse(Call<List<ModelMerProduct>> call, retrofit2.Response<List<ModelMerProduct>> response) {
                ...
                if (model.contains(null) || model.isEmpty()) {
                    ...
                    adapterViewAndroid = new Adapter_admin_add_product(mContext, model,AdminMerProduct.this);
