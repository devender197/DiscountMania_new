...
import com.virtualskillset.discountmania.merchant.ProfileUpdtProductFragment;
import com.virtualskillset.discountmania.merchant.retro.ModelMerProduct;

import java.util.List;

public class Adapter_add_product extends BaseAdapter {
    private Context mContext;
    private List<ModelMerProduct> lst;
    ProfileUpdtProductFragment frag;


    public Adapter_add_product(Context context,List<ModelMerProduct> lst ,ProfileUpdtProductFragment frag) {
        mContext = context;
        this.lst = lst;
        this.frag = frag;
    }
