...
import com.virtualskillset.discountmania.merchant.ProfileUpdtBannerFragment;
import com.virtualskillset.discountmania.merchant.retro.ModelMerBanner;

import java.util.List;

public class Adapter_add_banner extends BaseAdapter {
    private Context mContext;
    private List<ModelMerBanner> lst;
    ProfileUpdtBannerFragment frag;


    public Adapter_add_banner(Context context,List<ModelMerBanner> lst ,ProfileUpdtBannerFragment frag) {
        mContext = context;
        this.lst = lst;
        this.frag = frag;
    }
