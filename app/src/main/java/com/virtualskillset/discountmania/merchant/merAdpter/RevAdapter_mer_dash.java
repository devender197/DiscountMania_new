...
public class RevAdapter_mer_dash extends RecyclerView.Adapter<RevAdapter_mer_dash.ViewHolder> {

    private List<ModelMerDash.Review> reviews=new ArrayList<>();
    private LayoutInflater mInflater;
    //private ItemClickListener mClickListener;

    // data is passed into the constructor
    public RevAdapter_mer_dash(Context context, List<ModelMerDash.Review> reviews) {
    ...
    @Override
    @NonNull
    public RevAdapter_mer_dash.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.cell_mer_view_review, parent, false);
        return new RevAdapter_mer_dash.ViewHolder(view);
    }

    // binds the data to the TextView in each cell
    @Override
    public void onBindViewHolder(@NonNull RevAdapter_mer_dash.ViewHolder holder, int position) {
