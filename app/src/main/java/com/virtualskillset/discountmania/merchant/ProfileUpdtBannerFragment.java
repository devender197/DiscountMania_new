...
import com.virtualskillset.discountmania.merchant.merAdpter.Adapter_add_banner;
 ...
 */
public class ProfileUpdtBannerFragment extends Fragment {
    ...
    private Adapter_add_banner adapterViewAndroid;
    private Context mContext;
    ////grid///
    GridView androidGridView;


    public ProfileUpdtBannerFragment() {
...
//write the bytes in file
    ...
    private void getOffer() {
        ...
        Call<List<ModelMerBanner>> call = apiIfc.getMerBanner(mid);
        call.enqueue(new Callback<List<ModelMerBanner>>() {
            ...
            public void onResponse(Call<List<ModelMerBanner>> call, retrofit2.Response<List<ModelMerBanner>> response) {
                ...
                if (model.contains(null) || model.isEmpty()) {
                    ...
                    adapterViewAndroid = new Adapter_add_banner(mContext, model,ProfileUpdtBannerFragment.this);
