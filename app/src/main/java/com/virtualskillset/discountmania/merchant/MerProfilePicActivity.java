...
public class MerProfilePicActivity extends AppCompatActivity {
    ...
    private Context mContext=MerProfilePicActivity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mer_profile_pic);
        try {
...
//write the bytes in file
        ...
        Call<ModelResponse> call = uploadAPIService.updtMerchantImage(user.getId(),requestBody);
