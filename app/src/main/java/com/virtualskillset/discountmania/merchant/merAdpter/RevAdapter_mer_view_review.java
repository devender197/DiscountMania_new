...
public class RevAdapter_mer_view_review extends RecyclerView.Adapter<RevAdapter_mer_view_review.ViewHolder> {

    private List<ModelMerProduct> lst;
    private LayoutInflater mInflater;
    private Context mContext;
    private RevAdapter_category_home.ItemClickListener mClickListener;

    // data is passed into the constructor
    public RevAdapter_mer_view_review(Context context, List<ModelMerProduct> lst) {
    ...
    @Override
    @NonNull
    public RevAdapter_mer_view_review.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.grid_pro_dtl, parent, false);
        return new RevAdapter_mer_view_review.ViewHolder(view);
    }

    // binds the data to the TextView in each cell
    @Override
    public void onBindViewHolder(@NonNull RevAdapter_mer_view_review.ViewHolder holder, int position) {
   ...
   /* // convenience method for getting data at click position
    ...
    public void setClickListener(RevAdapter_category_home.ItemClickListener itemClickListener) {
